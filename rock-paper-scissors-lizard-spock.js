...
$(document).ready(function () {
  ...
  if (typeof Storage !== "undefined") {
    // Retrieve
    const temp = localStorage.getItem("rock-paper-scissors");
  ...
  $("#rules-btn").click(function () {
    const selectorByID =
      window.innerWidth < 725 ? "#mobile-rules" : "#desktop-rules";
    $(selectorByID).removeClass("hide").addClass("show-flex");
  });

  $(".close").click(function (e) {
    const selectorByID = $(e.currentTarget).parent().parent().attr("id");
    $("#" + selectorByID)
      .addClass("hide")
  ...
  $(".play-again>button").click(function () {
    const selectorByID =
      window.innerWidth < 725 ? "#mobile-results" : "#desktop-results";
  ...
  $("#gestures>.button").click(function (e) {
    const computerSelection = Math.round(Math.random() * 100) % 5,
      selectorByID =
        window.innerWidth < 725 ? "#mobile-results" : "#desktop-results";
    ...
    setTimeout(function () {
      $(".button-preview")
        .removeClass("button-preview")
        .addClass("button " + Object.keys(RULES)[computerSelection]);
      $(".house>.button").append(
        "<div>" + Object.values(RULES)[computerSelection].svg + "</div>",
      );
      ...
      setTimeout(function () {
        ...
        if (
          RULES[e.currentTarget.id].beats.includes(
            Object.keys(RULES)[computerSelection],
          )
        ) {
          ...
          $(".house>.button").addClass(
            Object.keys(RULES)[computerSelection] + "-winner",
          );
